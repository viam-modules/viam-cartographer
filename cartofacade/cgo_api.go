...
/*
	#cgo CFLAGS: -I../viam-cartographer/src/carto_facade
  	#cgo LDFLAGS: -L../viam-cartographer/build -L../viam-cartographer/cartographer/build -lcartographer  -lviam-cartographer  -labsl_raw_hash_set -labsl_hash  -labsl_str_format_internal  -labsl_synchronization    -labsl_strings  -labsl_throw_delegate -lcairo -llua -lstdc++ -lceres -lprotobuf -lglog -lboost_filesystem -lboost_iostreams -lpcl_io -lpcl_common
