...
/*
	// In the line below linking fails on an arm machine
	// #cgo CFLAGS: -I../viam-cartographer/src/carto_facade
	//TODO: check if removing homebrew prefix in cmake causes link to fail
	#cgo CFLAGS: -I../viam-cartographer/src/carto_facade -I/usr/include/lua5.3
