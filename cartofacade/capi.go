...
/*
	...
	#cgo LDFLAGS: -L../viam-cartographer/build -L../viam-cartographer/build/cartographer -lviam-cartographer -lcartographer -labsl_hash  -labsl_city -labsl_bad_optional_access -labsl_strerror  -labsl_str_format_internal -labsl_synchronization -labsl_strings -labsl_throw_delegate -lglog -ldl -lpcl_io -lpcl_common -lceres -lcairo  -lboost_iostreams -Wl,-Bstatic -lnlopt -lm -llua5.3 -lprotobuf -lboost_filesystem  -labsl_raw_hash_set -Wl,-Bdynamic -lstdc++ 
